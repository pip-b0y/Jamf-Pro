...
#Apps that are installed via SS, suck. PI- prevents using the "jamfselfservice://" app install links. So that sucks.
...
#Grab the Jamf Version need to make the name api friendly cause well api sucks with spaces:
